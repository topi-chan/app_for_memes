...
from one_app.db.db import Base, SQLALCHEMY_DATABASE_URL_ALEMBIC
from one_app.db.meme_models import *
...
config.set_main_option("sqlalchemy.url", SQLALCHEMY_DATABASE_URL_ALEMBIC)
...
def run_migrations_offline() -> None:
    ...
    context.configure(dialect_name="postgresql", starting_rev=current_version)
